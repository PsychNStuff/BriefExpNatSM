# Effects of a Brief Exposure to Nature or Social Media
...
Bar graphs were completed using R, after the data was cleaned and the measures were created in SPSS. The code in R does not clean the data or aggregate any measures.
